#nb_episodes added as per: https://github.com/keras-rl/keras-rl/issues/161
# -*- coding: utf-8 -*-
import warnings
...
class Agent(object):
    ...
    def fit(self, env, nb_steps = 1, nb_episodes = 0, action_repetition=1, callbacks=None, verbose=1,
        ...
        did_abort = False
        try:
            while self.step < nb_steps or episode<nb_episodes:
